...
import { ShoppingCart, Plus, Trash2, Send, Loader2, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div style={{ maxWidth: 480, margin: "0 auto", padding: "16px 16px 24px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20, padding: "16px 20px", background: "#fffbeb", borderRadius: 16, border: "1.5px solid #fde68a" }}>
        ...
        <div>
          <h1 style={{ fontSize: 20, fontWeight: 800, color: "#0f172a" }}>資材発注</h1>
          <p style={{ fontSize: 12, color: "#64748b", marginTop: 2 }}>マスタから品目を選んで発注</p>
        </div>
      </div>
